	      ...
	      public void createInvoice() throws IOException
	          {
		          ...
		          driver.findElement(By.name("subject")).sendKeys(data.fetchDataFromExcel("MyData",1,0));
	             ...
	             driver.findElement(By.xpath("//input[@id='qty1']")).sendKeys(data.fetchDataFromExcel("MyData", 2,0));
